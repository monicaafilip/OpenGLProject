...
IvDrawTeapot( IvColor color, bool useDefaultShader )
{
    ...
    if ( teapotVertexBuffer == 0 )
    {
     ...
     BuildTeapot( vertices, indices );
        ...
        teapotVertexBuffer = IvRenderer::mRenderer->GetResourceManager()->CreateVertexBuffer(kNPFormat, numTeapotVerts, dataPtr,kImmutableUsage);
        ...
        teapotIndexBuffer = IvRenderer::mRenderer->GetResourceManager()->CreateIndexBuffer(numTeapotIndices, indexPtr,kImmutableUsage);
